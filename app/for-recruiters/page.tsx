                ...
                <div className="flex flex-wrap gap-3 pt-1">
                  {project.links.live && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"                      className="inline-flex items-center gap-1.5 text-xs font-medium text-emerald-600 dark:text-emerald-400 hover:underline"
  ...
  return (
    <div className="min-h-svh bg-gradient-to-br from-background via-background to-emerald-950/10 dark:to-emerald-950/20">
      ...
      <main className="pt-16">
        ...
        {session ? <ProjectsSection /> : <GateSection onAuthenticated={setSession} />}
      </main>
